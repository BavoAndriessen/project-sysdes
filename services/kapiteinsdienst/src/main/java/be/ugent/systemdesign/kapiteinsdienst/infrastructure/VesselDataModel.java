...
public class VesselDataModel {
    ...
    */
    public VesselDataModel(Integer vesselNumber, VesselStatus status, LocalDateTime arrivalDateTime, LocalDateTime departureDateTime, Double vesselSize, Double amountOfWaste, Integer offerId, Double price, List<String> additionalServices, List<Container> containerList, List<Crew> crewList) {
        this.vesselNumber = vesselNumber;
        this.status = status;
        this.arrivalDateTime = arrivalDateTime;
        this.departureDateTime = departureDateTime;
